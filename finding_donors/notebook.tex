...
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
...
formatted.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
         \PY{n}{n\PYZus{}records} \PY{o}{=} \PY{n+nb}{len}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{index}\PY{p}{)}
         
         \PY{c+c1}{\PYZsh{} TODO: Number of records where individual\PYZsq{}s income is more than \PYZdl{}50,000}
         \PY{c+c1}{\PYZsh{}n\PYZus{}greater\PYZus{}50k = len([data[\PYZsq{}income\PYZsq{}] == \PYZsq{}\PYZgt{}50K\PYZsq{}])}
         ...
         \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{p}{(}\PY{n}{n\PYZus{}at\PYZus{}most\PYZus{}50k} \PY{o}{/} \PY{n}{n\PYZus{}records}\PY{p}{)}\PY{o}{*}\PY{l+m+mi}{100}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Percentage of individuals making more than \PYZdl{}50,000: }\PY{l+s+si}{\PYZob{}:.2f\PYZcb{}}\PY{l+s+s2}{\PYZpc{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{greater\PYZus{}percent}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
the range of the values present and how they are distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{c+c1}{\PYZsh{} Split the data into features and target label}
...
distributed.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}55}]:} \PY{c+c1}{\PYZsh{} Log\PYZhy{}transform the skewed features}
...
for this.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}56}]:} \PY{c+c1}{\PYZsh{} Import sklearn.preprocessing.StandardScaler}
...
with "\textgreater{}50K" to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
        \PY{n}{features\PYZus{}final} \PY{o}{=} \PY{k+kc}{None}
        
        \PY{c+c1}{\PYZsh{} TODO: Encode the \PYZsq{}income\PYZus{}raw\PYZsq{} data to numerical values}
        \PY{n}{income} \PY{o}{=} \PY{k+kc}{None}
...
Run the code cell below to perform this split.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} Import train\PYZus{}test\PYZus{}split}
